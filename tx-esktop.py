...
def ffmpeg(l,m,n):
    ...
    os.system("ffmpeg -f gdigrab -framerate 25 -i desktop "+codec+" -preset ultrafast -g 60 -vf format=yuv420p -f flv -vsync vfr -f rtsp -rtsp_transport "+trn+" rtsp://"+l+":"+m+"/"+n)
...
boton2=Button(ventana,text="Terminar", command=terminarTx, bg="red",width=18,height=2)
